...
folder = uigetdir('/media/ashley/My Passport/DOI_Image_Proj/Milan/EventFilter/DOI/Capil');
...
fn = ['/media/ashley/My Passport/DOI_Image_Proj/UXYCorrected/XY/London/DOI_',filename(10:end)];
if Uflood
